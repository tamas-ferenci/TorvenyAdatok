...
knitr::opts_chunk$set(echo = TRUE, fig.width = 16/3*2,
                      fig.height = 9/3*2, dpi = 300,
                      dev = "ragg_png")
library(data.table)
```
...
Azért érdemes ezt a megoldást választani, mert így, ha valamelyik lépésben hiba történik, akkor könnyebb újrakezdeni (persze elegánsabb lett volna egy `tryCatch` kivételkezelést használni). Ha sikerült, akkor töltsünk be mindent:
