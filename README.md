...
- <a href="#háttér-célkitűzés" id="toc-háttér-célkitűzés">Háttér,
  célkitűzés</a>
- <a href="#a-megvalósítás-alapvonalai"
  id="toc-a-megvalósítás-alapvonalai">A megvalósítás alapvonalai</a>
...
Azért érdemes előallokálni a vektort, majd for-ciklussal feltölteni,
mert így, ha valamelyik lépésben hiba történik, akkor könnyebb
újrakezdeni (persze elegánsabb lett volna egy `tryCatch` kivételkezelést
használni, és utána mehetett volna az egész egy `lapply`-ba).
